...
const JackpotTicketCountPanel: React.FC<JackpotTicketCountPanelProps> = ({ ticketCountStats }) => {
  return (
    <div className='bg-white rounded-2xl shadow-md border border-gray-100 dark:border-white/5 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {ticketCountStats.map(stat => (
          <div
            key={stat.draw_id}
            className="flex flex-col items-start rounded-xl p-3 bg-gradient-to-tr from-indigo-50 to-white 
                       dark:from-indigo-900/20 dark:to-gray-900 border border-gray-200 dark:border-gray-700 
