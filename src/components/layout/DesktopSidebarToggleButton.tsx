...
import { IconLayoutSidebarLeftExpand, IconDeviceGamepad3, IconDeviceMobileCheck, IconCamera, IconBrain, IconPlant, IconUserShield, IconSportBillard, IconCheese, IconArticle, IconCalendarCheck, IconAnalyze, IconCashRegister, IconLogout, IconUserEdit } from '@tabler/icons-react';
    ...
    return (
        <div className={`hidden lg:flex lg:flex-col fixed top-0 left-4 z-20 bg-transparent h-full min-h-0 ${className}`}>
            ...
            <div className="flex flex-1 flex-col overflow-y-auto space-y-0.5 pt-8 ">
                ...
                <ListLink to="/dashboard/cms" icon={<IconArticle size={16} />} label="CMS Content" iconOnlyMode={true} />
